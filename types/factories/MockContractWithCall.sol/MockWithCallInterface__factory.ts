...
/* eslint-disable */
import type {
  MockWithCallInterface,
  MockWithCallInterfaceInterface,
} from "../../MockContractWithCall.sol/MockWithCallInterface";
...
export class MockWithCallInterface__factory {
  static readonly abi = _abi;
  static createInterface(): MockWithCallInterfaceInterface {
    return new Interface(_abi) as MockWithCallInterfaceInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as MockWithCallInterface;
  }
}
